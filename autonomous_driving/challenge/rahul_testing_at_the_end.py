...
def train(path_to_images, csv_file):
    ...
    '''
    global min_steering_angle,max_steering_angle
    resized_images = []
    ...
    ## Bins Creation
    bins = np.linspace(min_steering_angle,130,output_layer_size) 
...
#         image_vector = (image_vector > threshold)
        
        resized_images.append(image_vector)
        
        
    # Train your network here. You'll probably need some weights and gradients!
    layer1 = image_size*cropped_image
    ## hidden layer
    layer2 = hidden_layer_size
    layer3 = output_layer_size
#     Neural Network Object
    NN = NeuralNetwork(layer1,layer2,layer3)
## layers 128 - 3800 - 4 has worked with gaussian as 0.6 , 0.3     
    iterations = 4300
