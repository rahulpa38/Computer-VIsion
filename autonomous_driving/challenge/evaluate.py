...
def evaluate(student_file = 'sample_student', 
             path_to_training_images = '/training/images',
             training_csv_file = '/training/steering_angles.csv', 
             path_to_testing_images = '/training/images',
             testing_csv_file = '/training/steering_angles.csv', 
             time_limit = 600):
